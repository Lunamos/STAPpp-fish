...
{
	output << setw(9) << NodeNumber << setw(5) << bcode[0] << setw(5) << bcode[1] << setw(5) << bcode[2] // for translational DOF
		   << setw(5) << bcode[3] << setw(5) << bcode[4] << setw(5) << bcode[5]	                         // for rotational DOF
